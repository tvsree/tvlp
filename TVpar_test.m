...
%  %--------------
%      wavfil = 'adha.wav';
%      [sig,Fs] = audioread(wavfil);
%      [bgnSmp,endSmp] = spchNdpt(sig,Fs);
%      
%      lpcRdr = 12;
%      polRdr = 3;
%      [RCpls RCmns RCavg] = tvLP_LAR(sig,lpcRdr,polRdr,'pol');
%      
%  return
%  %----------------

%----------------------------------------------------------
% Test TVLP_LAR solution using the TV_Lattice formulation
% The data are CVC/VCV syllable files from OLLO database
