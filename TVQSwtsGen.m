...
% QS_Aut parameter contours are curve fitted using the selected bases functions
...
%               outPath = '/prosjekt/tvs/TVLPexpt/';
                ...
                for n = bgnSmp:bigShft:endSmp,
                    ...
                    [LSFoptWts fitdContr avgMSEdb] = contourFit(lsfAutContr(n:n+bigWnd,polRdr,'sin');
                    ...
                    [RCoptWts fitdContr avgMSEdb] = contourFit(rcContr(n:n+bigWnd,polRdr,'sin');
                    % choose among bases type: "pol"ynomial, "sin"e or "Leg"endre
...
%               outPath = '/prosjekt/tvs/TVLPexpt/';
                ...
                %                  tvlarFilID = fopen([outPath1 name '.tvlar'],'w');
                outPath2 = './TVLPcWts/';
...
%                          fprintf(tvlarFilID,'%8.0f \n',PhnLbl);
                    ...
                    [LSFoptWts fitdContr avgMSEdb] = contourFit(TVLSF(:,prvCnt+1:frmCnt4),polRdr,'sin');
                    % choose among bases type: "pol"ynomial, "sin"e or "Leg"endre
                    prvCnt = frmCnt4;
                    ...
                    fprintf(tvLwtsFilID,'%9.0f',filCnt-1,frmCnt2-1);
                    fprintf(tvLwtsFilID,'%8.4f',LSFoptWts);
                    fprintf(tvLwtsFilID,'%8.0f \n',PhnLbl);
                    
                    [RCoptWts fitdContr avgMSEdb] = contourFit(rcContr(:,prvCnt+1:frmCnt4),polRdr,'sin');
                    % choose among bases type: "pol"ynomial, "sin"e or "Leg"endre

                    fprintf(tvRwtsFilID,tvRwtsFil);
                    fprintf(tvRwtsFilID,'%9.0f',filCnt-1,frmCnt2-1);
                    fprintf(tvRwtsFilID,'%8.4f',RCoptWts);
