...
%                [path,name,ext] = fileparts(wavFil);  % construct output feature filenames
                lsfFil = [name '.lsf'];
                lsfFilID = fopen(['./QSexpt0_Kaldi/' lsfFil],'w');
                
                rcFil = [name '.rc'];
                rcFilID = fopen(['./QSexpt0_Kaldi/' rcFil],'w');
                
                larFil = [name '.lar'];
                larFilID = fopen(['./QSexpt0_Kaldi/' larFil],'w');
