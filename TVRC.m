...
%------------------------------------------------------------------
  function [RCpls RCmns RCavg resPls1 resMns1 resPls2 resMns2] = tvLP_LAR(sig,lpcRdr,polRdr,type);
%------------------------------------------------------------------
...
% successive stage outputs, because of different K_ij solutions
