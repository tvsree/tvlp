...
% TV_LPC analysis; whole syllable is analysed using a TVLP model
                ...
                frmCnt2 = 0;
                for m = 1:wndShft:endSmp-bgnSmp+1-wndShft, % sampling of continuous LPC contour
                    frmCnt2 = frmCnt2+1;
                    Ak_smp = TVAk(:,m);
...
% TV_Lattice analysis; whole syllable is analysed using the TV_Lattice model
                ...
                frmCnt3 = 0;
                for m = 1:wndShft:endSmp-bgnSmp+1-wndShft,   % sampling of continuous contour
                    frmCnt3 = frmCnt3+1;
                    ...
                    lar = rc2lar(RCpls(:,m));                % log area-ratio from RC contour
